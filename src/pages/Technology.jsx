...
const Technology = ({ searchValue }) => {
    ...
    useEffect(() => {
        const getResp = async () => {
            const { data } = await axios.get('https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=a696c20c66a14d83b49a0e92733c1675');
